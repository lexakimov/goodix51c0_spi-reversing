...
Получение флагов конфигурации MCU:
```
write
    a0 09 00 a9
        a0    - флаг MSG_PROTOCOL
...
read
    ...
    01 00 00 00 4c 9c e6 7c 50 c6 b0 4b b6 37 cd 1c 72 51 14 ee 04 00 00 00 40 00 00 00 54 00 68 00
    ...
    00 01 00 00 20 00 00 00 6e 4f a0 f0 c6 eb 2c 20 5b f3 09 19 73 5f 8e 39 ce 6a 75 1a 66 e1 35 de
    92 fd aa 1c 9f 16 df 43 00 00 00 00 0e 80 00 00 00 02 00 00 20 00 00 00 be 11 9b ea 58 88 c5 88
    61 21 86 d6 e3 32 63 14 be 59 64 79 49 eb 55 52 b8 d6 c9 c5 ad 0d 98 11 30 00 00 00 cb 4a b3 4e
    61 d0 45 80 ca cc 20 85 21 68 5b e9 6b bb a7 35 59 87 8d 70 df 9f 85 73 8a b5 74 36 d5 06 a8 d0
    12 f8 93 38 7f e3 32 fe 32 53 f9 bc 40 00 00 00 5a a4 2a c1 1c 54 b4 e8 af 8a bc 02 e1 cf 9e bd
    a8 23 bd 05 65 13 e6 c5 dc 7d e5 a0 ba a3 c5 e3 57 da 67 a3 4b d3 35 f1 54 29 c6 c4 49 a3 c4 5b
    37 92 f8 27 d3 92 e5 f7 2a 00 15 30 c0 81 7a 3a 6b e5 a0 cb ee f0 3c 0b 03
...
write
    ...
    76 fd ad 0c 67 00 00 ad
        ...
        76 fd ad 0c 67
            ...
            [ HMAC SHA-256- подпись пакета со смещения 32 до конца, для проверки целостности на стороне MCU (32 байта) ]
            fa d1 e5 b8 79 30 26 5d b0 ed 25 44 e3 61 50 56 f6 19 fc 11 e6 a5 58 f8 e0 d9 20 03 e4 79 ff 41
            [ Заголовок (тип, подтип) (0x02, 0xFF) (2 байта) ]
            02 ff
            [ Длина исходных данных (pskLength) = 0x20 = 32 байта (4 байта) ]
            20 00 00 00
            [ Часть промежуточного хэша (16 байт) ]
            7d dc fc db a9 e8 1b 0c 48 15 63 8d 03 05 30 3b
            [ Шифротекст (PSK зашифрованный через AES) (pskLength = 32 байт) ]
            56 2e 5f 40 14 f4 0b 9d 76 ed f2 75 5d 9e 5d bd 86 94 b0 50 8d f7 86 19 3d ed df ca 48 54 fe f9
            [ Аутентификационный тег AES-GCM (16 байт) ]
            3f 68 a5 d5 cf de ec 15 24 29 05 76 fd ad 0c 67
            
            шифрование и дешифрование PSK -> PSK WB описано в соответствующих скриптах

        0000    - дополнение нулевыми байтами, чтобы длина стала кратна 4 (4+4+332+4+4+102=450; (4-450%4)%4=2 байта)
...
read
    ...
    a9 a6 bd a9 3a 8c 4d 61 cd 58 3f 3c e2 7a 8c d8 7f bf a7 ac 02 22 63 26 5c 10 7c ed 93 b5 00 df f9 b8 e1 0d 2e 1b d3 fd ae 27
        ...
        TLS-зашифрованный пакет с изображением. После расшифровки - 7693 байт (см далее)
...
read
    C0 0D 1E EB
        С0    - флаг ???
        0D 1E - полная длина следующего пакета в LE-notation (7693)
